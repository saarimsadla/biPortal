...
$wlId = isset($_GET['wlId']) ? $_GET['wlId'] : null;
$qry = isset($_GET['qry']) ? $_GET['qry'] : null;

// Echo them if they are set
/*
if ($wlId !== null) {
    echo "whitelabel: " . htmlspecialchars($wlId) . "<br>";
}
...
$initial_data = json_decode($ini_out, true);

if (!$initial_data) {
	die('{"Error": "Data not returned for provided qry."}');
}
