...
mysql_databases = mysql_databases = [
    {
        "host": "xcelprod.ch6nseb8g2s1.us-west-2.rds.amazonaws.com",
        "user": "hurs_extracts",
        "password": "GpDVmdWamE3qECGJyqrj",
        "database": "ytbremsc_prod",
        "wlId": [46]
    ...
    {
        "host": "entergyprod.ch6nseb8g2s1.us-west-2.rds.amazonaws.com",
        "user": "hurs_extracts",
        "password": "GpDVmdWamE3qECGJyqrj",
        "database": "ytbremsc_prod",
        "wlId": [38]
    ...
    {
        "host": "prodvpc-new.ch6nseb8g2s1.us-west-2.rds.amazonaws.com",
        "user": "hurs_extracts",
        "password": "GpDVmdWamE3qECGJyqrj",
        "database": "ytbremsc_prod",
        "wlId": [52, 47]
    ...
    try:
        with conn.cursor() as cursor:
            ...
            if result: 
                ...
                filename = "/var/www/html/hursPortal/phpRunners/customer_data.csv"
                decfilename = "/var/www/html/hursPortal/phpRunners/Dec_customer_data.csv"
                ...
                commandDec = ["php", "-f", "csv_decrypt_new.php", filename, decfilename, columns]
