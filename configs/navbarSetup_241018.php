    ...
    <script>
 	...
 	<nav class="navbar navbar-expand navbar-dark bg-dark static-top" id="navBar">
		<div class="d-flex align-items-center">
			...
			<a class="navbar-brand" href="dashboard.php">Hers Portal</a>
			...
			<div class="centered-div">
				...
				<li class="nav-item dropdown no-arrow">
					...
					<div class="dropdown-menu" aria-labelledby="pagesDropdown2">
						<?php
						sort($whtLblArray);
						foreach ($whtLblArray as $whtLbl) : ?>
							<a class="dropdown-item" href="#" onclick="handleDropdownItemClick('<?php echo $whtLbl; ?>')">
								<?php
								switch ($whtLbl) {
									case 0: {
											echo "Client: Please Select";
